...
#     print(data['0'])
    ...
    for i in range(len(data)):
        try:
            ...
            raise ValueError('Wrong JSON format! Save entries as a list instead of a dictionary.')
...
def main(args):
    vocab = build_vocab(cap_file=CAP_FILE.format(
        args.data_set), threshold=args.threshold)
